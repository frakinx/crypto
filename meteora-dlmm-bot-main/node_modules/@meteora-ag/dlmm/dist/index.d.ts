...
interface InitializeMultiplePositionAndAddLiquidityByStrategyResponse2 {
    instructionsByPositions: {
        positionKeypair: Keypair;
 ...
 */
declare const getEstimatedComputeUnitUsageWithBuffer: (connection: Connection, instructions: TransactionInstruction[], feePayer: PublicKey, buffer?: number, altAddress?: PublicKey) => Promise<number>;
/**
 ...
 */
declare const getEstimatedComputeUnitIxWithBuffer: (connection: Connection, instructions: TransactionInstruction[], feePayer: PublicKey, buffer?: number, altAddress?: PublicKey) => Promise<TransactionInstruction>;
type Opt = {
